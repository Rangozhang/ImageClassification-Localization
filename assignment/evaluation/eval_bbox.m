...
testfile = '~/Sec_6/bbox_results.txt';
gtfile = '/scratch/16824/data/testlist_bbox.txt';
savefolder = 'imgs/'
...
while ~feof(fid)
	...
	if mod(cnt, 1000) == 0
		...
		imwrite(im, [savefolder num2str(cnt) '.jpg']);
	end
...
fprintf('IOU 0.5: %f, IOU 0.7: %f IOU 0.8: %f', prop1, prop2, prop3);
