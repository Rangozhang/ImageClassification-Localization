...
caffe.set_device(0)
caffe.set_mode_gpu()
net = caffe.Net('/home/yuz4/Sec_9/test.prototxt',
                '/home/yuz4/Sec_9/models/model_iter_30000.caffemodel',
                caffe.TEST)
...
for i in range(batch_count):
	...
	for j in range(batch_size):
		...
		prop_ = net.blobs['fc8_reg'].data[j]
		prop_cls = out['cls_loss'][j].argmax()

		strt_ind = 4*prop_cls
		prop = np.array([prop_[strt_ind], prop_[strt_ind+1],prop_[strt_ind+2],prop_[strt_ind+3]])
